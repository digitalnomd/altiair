...
| Pi 5 low-latency candidate | `google/gemma-3-1b-it` or Ollama `gemma4:e2b` if available locally | `llama.cpp` or Ollama | Fast cue summaries and UI-facing explanations. |
